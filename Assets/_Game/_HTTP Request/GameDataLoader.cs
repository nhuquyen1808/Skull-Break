...
public class GameDataLoader : MonoBehaviour
{
    ...
    [Header("UI (tuỳ chọn)")]
    public TextMeshProUGUI uiName;                // assign nếu dùng Unity UI
    ...
    public int timeoutSeconds = 10;    // request timeout
    public int maxRetries = 2;         // số lần thử lại khi lỗi mạng
    
    [HideInInspector]
    public GameData data;              // dữ liệu đã parse
    ...
    void ApplyDataToGame(GameData d)
    {
